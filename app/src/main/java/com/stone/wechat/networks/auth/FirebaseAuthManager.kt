...
interface FirebaseAuthManager {
    ...
    fun checkCurrentUser(onSuccess: (String) -> Unit, onFailure: (errorMessage: String?) -> Unit)
    ...
    fun getCurrentUser(onSuccess: (String) -> Unit, onFailure: (errorMessage: String) -> Unit)
